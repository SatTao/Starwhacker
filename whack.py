...
s_1 = skyView(s,'bounds.ini','testRegion') # A part of s bounded by constraints in the .ini file
s_1.doStats().vitalStatistics()

p1 = stereoProjection(s_1, [-30,-30], 1).normalise() # A normalised stereo projection centred on 0 longitude, -40 latitude, with a scale factor of 1
